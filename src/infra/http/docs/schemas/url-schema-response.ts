...
export const urlSchemaResponse = z.object({
  id: z.uuidv7().describe('ID of URL'),
  author_id: z.uuidv7().describe('ID of author'),
  ...
  like: z.number().describe('Number likes tht URL got'),
  ...
  created_at: z.date().describe('Identifier when URL was created'),
  updated_at: z.date().describe('Identifier when URL was updated').nullable(),
});
