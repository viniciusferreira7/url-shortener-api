import { LikeUrlUseCase } from '@/domain/url-shortening/application/use-cases/like-url';
...
export function makeLikeUrlUseCase(): LikeUrlUseCase {
  ...
  return new LikeUrlUseCase(usersRepository, urlsRepository);
}
